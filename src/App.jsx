    ...
    <>
      ...
      <Main>
        <Box>
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <List movies={movies} onSelectMovie={handleSelectedMovie} />
          )}
        ...
        <>
          ...
          <section>
            <div className="rating">
              {isWatched ? (
                <p>You have rated this movie. {userRating}</p>
              ) : (
                <>
                  <StarRating
                    size={24}
...
function WatchedList({ watched = { watched }, onDeleteWatched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <li key={movie.imdbID}>
